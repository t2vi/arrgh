...
describe('ChapterRow', () => {
  it('shows BookOpen button when downloaded', () => {
    render(ChapterRow, {
      chapter: makeChapter({ downloaded: true }),
      progress: null,
      queueItem: null,
      pendingRead: false,
      onOpen: noop,
  ...
  it('shows Download button when not downloaded and has_sources', () => {
    render(ChapterRow, {
      chapter: makeChapter({ downloaded: false, has_sources: true }),
      progress: null,
      queueItem: null,
      pendingRead: false,
      onOpen: noop,
  ...
  it('shows no download button when has_sources is false and not downloaded', () => {
    const { container } = render(ChapterRow, {
      chapter: makeChapter({ downloaded: false, has_sources: false }),
      progress: null,
      queueItem: null,
      pendingRead: false,
      onOpen: noop,
  ...
  it('shows spinner when downloading', () => {
    const { container } = render(ChapterRow, {
      chapter: makeChapter(),
      progress: null,
      queueItem: makeQueueItem({ status: 'downloading' }),
      pendingRead: false,
      onOpen: noop,
      onCancelDownload: noop,
    })
  ...
  it('shows Queued button when pending', () => {
    render(ChapterRow, {
      chapter: makeChapter(),
      progress: null,
      queueItem: makeQueueItem({ status: 'pending' }),
      pendingRead: false,
      onOpen: noop,
      onCancelDownload: noop,
    })
  ...
  it('calls onCancelDownload when Queued button clicked', async () => {
    ...
    render(ChapterRow, {
      chapter: makeChapter(),
      progress: null,
      queueItem: makeQueueItem({ status: 'pending', id: 'q-99' }),
      pendingRead: false,
      onOpen: noop,
  ...
  it('shows AlertCircle when error', () => {
    render(ChapterRow, {
      chapter: makeChapter(),
      progress: null,
      queueItem: makeQueueItem({ status: 'error' }),
      pendingRead: false,
      onOpen: noop,
      onCancelDownload: noop,
    })
  ...
  it('shows download progress % when downloading with pages', () => {
    render(ChapterRow, {
      chapter: makeChapter(),
      progress: null,
      queueItem: makeQueueItem({ status: 'downloading', pages_downloaded: 8, pages_total: 20 }),
      pendingRead: false,
      onOpen: noop,
      onCancelDownload: noop,
    })
  ...
  it('hides download progress bar when pages_total is 0', () => {
    render(ChapterRow, {
      chapter: makeChapter(),
      progress: null,
      queueItem: makeQueueItem({ status: 'downloading', pages_downloaded: 0, pages_total: 0 }),
      pendingRead: false,
      onOpen: noop,
      onCancelDownload: noop,
    })
  ...
  it('completed chapter has reduced opacity', () => {
    const { container } = render(ChapterRow, {
      chapter: makeChapter({ downloaded: true }),
      progress: makeProgress({ completed: true }),
      queueItem: null,
      pendingRead: false,
      onOpen: noop,
      onCancelDownload: noop,
    })
    expect(container.querySelector('[data-chapter-id]')).toHaveClass('opacity-50')
  })

  it('shows read progress bar width when started but not completed', () => {
    const { container } = render(ChapterRow, {
      chapter: makeChapter({ downloaded: true, page_count: 20 }),
      progress: makeProgress({ current_page: 10, completed: false }),
      queueItem: null,
      pendingRead: false,
      onOpen: noop,
      onCancelDownload: noop,
