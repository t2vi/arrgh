...
describe('ContentTypeFilter', () => {
  it('renders nothing when availableTypes is empty', () => {
    const { container } = render(ContentTypeFilter, { value: undefined, onChange: () => {}, availableTypes: new Set<string>() })
    expect(container.textContent?.trim()).toBe('')
  })

  it('shows "All" and only types in availableTypes', () => {
    render(ContentTypeFilter, { value: undefined, onChange: () => {}, availableTypes: new Set(['manga', 'manhwa']) })
  ...
  it('calls onChange(undefined) when "All" is clicked', async () => {
    ...
    render(ContentTypeFilter, { value: 'manga', onChange, availableTypes: new Set(['manga']) })
  ...
  it('shows Hentai pill when hentai is in availableTypes', () => {
    render(ContentTypeFilter, { value: undefined, onChange: () => {}, availableTypes: new Set(['manga', 'hentai']) })
  ...
  it('shows Novel pill when novel is in availableTypes', () => {
    render(ContentTypeFilter, { value: undefined, onChange: () => {}, availableTypes: new Set(['manga', 'novel']) })
