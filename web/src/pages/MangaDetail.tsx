...
import { api, isAdmin, type QueueItem } from '@/api'
...
import { useMangaDetail, CHAPTERS_PREVIEW, type FilterMode } from '@/features/manga-detail/hooks/useMangaDetail'
...
function ExplicitCard({ mangaId, value }: { mangaId: string; value: boolean }) {
  const [current, setCurrent] = useState(value)
