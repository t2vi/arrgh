...
import { ChevronRight, Loader2, Check, Trash2, ShieldCheck, Eye } from 'lucide-react'
import { useNavigate } from 'react-router-dom'
import { api, clearToken, isAdmin, type UserListItem } from '@/api'
...
type Tab = 'library' | 'users' | 'account'
