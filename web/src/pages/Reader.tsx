...
export default function Reader() {
  ...
  const { data: progress } = useQuery({
    ...
    queryFn: () => api.getProgress(chapterId!).catch(() => null),
  })
  ...
  const { data: manga } = useQuery({
    ...
    queryFn: () => api.getManga(chapter!.manga_id),
  ...
  function goTo(p: number) {
    ...
    if (completed) qc.invalidateQueries({ queryKey: ['progress-manga', chapter?.manga_id] })
  }
